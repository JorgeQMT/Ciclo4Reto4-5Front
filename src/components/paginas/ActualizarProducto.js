...
const ActualizarProducto = () => {
   ...
   const {reference} = useParams();
    ...
    const { brand, price, photography, category, name, quantity,description, } = productosActualizar;
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try{ console.log(datos);
                        fetch(`http://168.138.249.154:8080/api/cosmetics/update`, {
                            method: "PUT",
            ...
            <div className="flex justify-center mt-10">
                        <div className="w-full max-w-3xl">
                            <form onSubmit={formik.handleSubmit}>
                                ...
                                <div className="mb-4">
                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="nombre">DISPINIBILIDAD</label>
                                    <select 
                                ...
                                <input type="submit" className="bg-yellow-800 hover:bg-gray-900 w-full mt-5 p-2 text-white uppercase font-bold" value="Actualizar Producto"/>
                            </form>
                        </div>
                    </div>
            </div>
